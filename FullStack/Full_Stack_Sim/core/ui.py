...
# ==========================================
# 1. HANDHELD UI COMPONENTS (For Simulations)
# ==========================================

class HandheldChassis:
    """
    Draws the rugged industrial device background.
    """
    ...
    def handle_event(self, event):
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_BACKSPACE:
                ...
                # BUG FIX: Increased character limit and allowed the ':' character
                if len(self.text) < 12: # Increased from 8 to 12
                    if event.unicode.isalnum() or event.unicode in ':-': # Added ':' to allowed characters
...
# ==========================================
# 2. STANDARD UI COMPONENTS (For Main Menu)
# ==========================================

class Button:
    """
    Standard rectangular button used in Main Menu and Back buttons.
    Reskinned to match the Industrial Theme.
    """
    ...
    def draw(self, screen):
        # Colors (Industrial Grey/Blue theme)
        base_color = (60, 70, 80)
        ...
        # Draw Main Button (Shift down if pressed)
